...
<div class="container my-5" style="position: relative; z-index: 10;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1"><i data-feather="users"></i> Data User</h2>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <small class="text-muted"><i data-feather="shield"></i> Role:</small>
                        <p class="mb-0 text-capitalize">{{ $item->role }}</p>
                    </div>

                    <div class="mb-3">
                        <small class="text-muted"><i data-feather="calendar"></i> Dibuat:</small>
                        <p class="mb-0"><small>{{ $item->created_at->format('d M Y H:i') }}</small></p>
                    </div>

                    <div>
                        <small class="text-muted"><i data-feather="edit"></i> Diupdate:</small>
                        <p class="mb-0"><small>{{ $item->updated_at->format('d M Y H:i') }}</small></p>
                    </div>
                </div>
