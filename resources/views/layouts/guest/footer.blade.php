    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                ...
                <a class="btn btn-link" href="{{ route('services') }}">Interior Design</a>
                <a class="btn btn-link" href="{{ route('services') }}">Project Planning</a>
                <a class="btn btn-link" href="{{ route('services') }}">Renovation</a>
                <a class="btn btn-link" href="{{ route('services') }}">Implement</a>
                <a class="btn btn-link" href="{{ route('services') }}">Landscape Design</a>
            </div>
        </div>
    </div>
