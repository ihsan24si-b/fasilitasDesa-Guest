...
class WargaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 100; $i++) {
            $jenisKelamin = $faker->randomElement(['L', 'P']); // UBAH: L/P bukan Laki-laki/Perempuan
            $nama = $jenisKelamin === 'L' ? $faker->firstNameMale() : $faker->firstNameFemale();
            $nama .= ' ' . $faker->lastName();
            ...
            Warga::create([
                ...
                'nama_lengkap' => $nama, // UBAH: dari 'nama' ke 'nama_lengkap'
                'jenis_kelamin' => $jenisKelamin, // UBAH: L/P
                'agama' => $faker->randomElement($agama),
                'pekerjaan' => $faker->randomElement($pekerjaan),
                'no_telepon' => $telp, // UBAH: dari 'telp' ke 'no_telepon'
